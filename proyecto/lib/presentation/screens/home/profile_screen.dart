...
import '../../viewmodels/ahorros_viewmodel.dart';
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Usar ChangeNotifierProvider para AhorrosViewModel
    return ChangeNotifierProvider(
      create: (_) {
        final vm = AhorrosViewModel();
        vm.cargarAhorroDesdePlanes(); // Solo suma de planes, no guarda en Firebase
        return vm;
      },
      child: Scaffold(
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  // Tarjeta de ahorro
                  Consumer<AhorrosViewModel>(
                    builder: (context, ahorrosVM, _) {
                      return Container(
                          ...
                          children: [
                            ...
                            Text(
                              ahorrosVM.ahorro != null
                                  ? '\$${ahorrosVM.ahorro!.toStringAsFixed(2)}'
                                  : 'Cargando...',
                              style: AppTextStyles.headline.copyWith(
